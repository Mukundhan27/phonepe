...
st.markdown("<h1 style='color: red; font-family: Arial, sans-serif; font-size: 24px;'>PHONEPE DATA VISUALIZATION AND EXPLORATION</h1>", unsafe_allow_html=True)
tab1, tab2, tab3 = st.tabs(["***HOME***","***EXPLORE DATA***","***ANALYSIS***"])

with tab1:
    col1,col2= st.columns(2)

    with col1:
        st.markdown("<h2><FONT COLOR='#7505b5'>Phone Pe</h2>",unsafe_allow_html=True)
        st.markdown("<h3 style='color: RoyalBlue;'>INDIA'S BEST TRANSACTION APP</h3>", unsafe_allow_html=True)
    ...
    with col2:
        st.image("https://www.equitypandit.com/wp-content/uploads/2023/05/PhonePe-Lands-Another-100-Million-from-General-Atlantic-in-Ongoing-1B-Funding-Round-EP.jpg", caption="PhonePe", use_column_width=True)

    col3,col4= st.columns(2)
    
    with col3:
        st.image("https://cdn.dribbble.com/users/1902890/screenshots/15619502/media/4110e14facc720955ac1ad0ae1589477.gif", caption="Phonepe Digital", use_column_width=True)
    ...
    with col6:
        st.image("https://www.phonepe.com/pulsestatic/767/pulse/static/home_og_image-adc70b0401140d689c55d37cfce6161e.jpeg", caption="PhonePe India", use_column_width=True)
