...
path1="E:/caps projects/phonepe/pulse/data/aggregated/transaction/country/india/state/"
...
#aggre_user
path2="E:/caps projects/phonepe/pulse/data/aggregated/user/country/india/state/"
...
#map_transaction
path3="E:/caps projects/phonepe/pulse/data/map/transaction/hover/country/india/state/"
...
#map_user
path4="E:/caps projects/phonepe/pulse/data/map/user/hover/country/india/state/"
...
#top_transaction
path5="E:/caps projects/phonepe/pulse/data/top/transaction/country/india/state/"
...
#top_user
path6="E:/caps projects/phonepe/pulse/data/top/user/country/india/state/"
...
for index,row in aggre_tranaction.iterrows():
...
for index,row in aggre_user.iterrows():
    insert_query1 = '''insert into aggregated_user (States, Years, Quarter, Brands, Transaction_count, Percentage)
                                                    values(%s,%s,%s,%s,%s,%s)'''
    values = (row["States"],
              row["Years"],
              row["Quarter"],
